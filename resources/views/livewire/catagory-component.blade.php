    ...
    @foreach ($posts as $item)
        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
            <div class="product product-style-3 equal-elem ">
                ...
                <a href="" class="btn add-to-cart"  wire:click="store({{ $item->id }},'{{ $item->name }}',{{$item->reguler_price }})">Add To Cart</a>
                </div>
            </div>
        </li>
        @endforeach
						...
						<div class="widget-content">
							<ul class="list-category">
                                 ...
                                 <li class="category-item">
									<a href="{{ route('product.catagory',['catagory_slug'=>$cat->slug])}}" class="cate-link">{{ $cat->name }}</a>
								</li>
